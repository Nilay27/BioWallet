import { DEFAULT_TASK_TIMEOUT, TokenTransfer, TransferState, Wormhole, api, tasks, } from "@wormhole-foundation/sdk";
...
export async function waitForRelay(txid) {
    const relayerApi = "https://relayer.dev.stable.io";
    const task = () => api.getRelayStatus(relayerApi, txid);
    return tasks.retry(task, 5000, 60 * 1000, "Wormhole:GetRelayStatus");
}
